...
import { BonadocsEditorProjectsCreationActionContractInstanceSelectedList } from "./BonadocsEditorProjectsCreationActionContractInstanceSelectedList";

interface BonadocsEditorProjectsCreationActionContractInstanceSelectedProps {
  // Add any props you need here
}

export const BonadocsEditorProjectsCreationActionContractInstanceSelected: React.FC<
  BonadocsEditorProjectsCreationActionContractInstanceSelectedProps
> = (props) => {
  ...
  return (
    <div className="bonadocs__editor__projects__creation__selection">
      ...
      <BonadocsEditorProjectsCreationActionContractInstanceSelectedList searchValue={search} />
    </div>
  );
};
